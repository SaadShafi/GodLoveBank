...
const CoreValuesTimerThree = () => {
  ...
  const [loading, setLoading] = useState(false);
    ...
    console.log("Received Third Timer CoreValueId:", coreValueId);
      ...
      setIsRunning(false);
        ...
        try {
          ...
          if (response?.data?.data) {
            ...
            console.log("Received CoreValueTimerThree CoreValueId from API:", receivedCoreValueId);
            ...
            // navigation.navigate('SelfHonesty')
            // Navigate dynamically to original screen
          const previousScreen = route.params?.fromScreen || 'SelfHonesty';
