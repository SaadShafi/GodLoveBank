...
const SelfImage = () => {
  ...
  console.log('Self Image Data:', coreValue);
...
useEffect(() => {
  ...
  return (
    <SafeAreaView style={styles.safeContainer}>
      ...
      >
        <Image source={images.selfimage} style={styles.img} />
        ...
        {/* <Text style={styles.jan}>JULY</Text> */}
        <Text style={styles.jan}>{coreValue?.type}</Text>
        <Text style={styles.luke}>1. One Talent Man. (Mt. 25:14-30)</Text>
        <Text style={styles.peter}>2. he Woman at the Well (John 4:5-25)</Text>
        <Text style={styles.nanas}>
          3. Adam & Eve Story (Gen.1:24-31; 2:7-8)
        </Text>
        <Text style={styles.publican}>
          4. Story of the Pounds (Luke 19:12-27)
        </Text>

        <View>
          <Text style={styles.today}>
            I see myself as God sees me; I am a Spirit,{' '}
          </Text>
          <Text style={styles.today}>I have a Soul, and I live in a Body!</Text>
        </View>
        ...
        <View style={{ gap: height * 0.02 }}>
          <View style={styles.btn}>
            <CustomButton
              ...
              onPress={() => navigation.navigate("CoreValuesTimer", { coreValueId: 22, fromScreen: 'SelfImage' })}
            />
          </View>
