    ...
    return (
        <View style={styles.mainContainer}>
            ...
            <View>
                ...
                <Text style={styles.text}>Lorem ipsum dolor sit amet consectetur. Vitae etiam lectus</Text>
                <Text style={styles.text}>venenatis nam amet pellentesque Feugiat at amet ornare</Text>
