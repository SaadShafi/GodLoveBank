...
useEffect(() => {
  ...
  return (
    <SafeAreaView style={styles.safeContainer}>
      ...
      >
        <Image source={images.courage} style={styles.img} />
        ...
        <Text style={styles.nanas}>
          3. Nehemiah Rebuilds Walls (Neh:1-2:20)
        </Text>
        <Text style={styles.publican}>
          4. Saved By A Courage Lad (Acts 23:12-35)
        </Text>

        <View>
          <Text style={styles.today}>
            Today, I will be courageous and do what is
          </Text>
          <Text style={styles.today}>right, even when no one else will!</Text>
        </View>
