...
const ECommerce = () => {
    ...
    return (
        <View style={{ flex: 1 }}>
            <TopHeader isMenu={true} isProfile={true} notification={true} isCart={true} />
                ...
                >
                    <View style={styles.recommendedBooksMain}>
                        <View style={styles.recommendedHeadText}>
                            <Text style={styles.recommendedTextOne}>Recommended Books For You</Text>
                        ...
                        <FlatList
                            ...
                            contentContainerStyle={{ paddingHorizontal: 10, marginTop: height * 0.01, left: width * 0.03 }}
                        />
                    </View>
