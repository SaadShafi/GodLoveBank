...
const SelfIntegrity = () => {
  ...
  console.log('Self Integrity Data:', coreValue);
...
useEffect(() => {
  ...
  return (
    <SafeAreaView style={styles.safeContainer}>
      ...
      >
        <Image source={images.integrity} style={styles.img} />
        ...
        <Text style={styles.luke}>
          1. Abraham’s Calling (Gen 12:1-9; 13:1-5)
        </Text>
        <Text style={styles.peter}>2. Abraham’s s Tested (Gen. 22:1-19)</Text>
        <Text style={styles.nanas}>3. Ten Plagues (Exodus 7:1-12:50)</Text>
        <Text style={styles.publican}>4. Achan’s Sin (Joshua 7:1-26)</Text>
        ...
        <View style={{ gap: height * 0.02 }}>
          <View style={styles.btn}>
            <CustomButton
              ...
              onPress={() => navigation.navigate("CoreValuesTimer", { coreValueId: 29, fromScreen: 'SelfIntegrity' })}
            />
          </View>
