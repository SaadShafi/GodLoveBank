...
useEffect(() => {
  ...
  return (
    <SafeAreaView style={styles.safeContainer}>
      ...
      >
        <Image source={images.discipline} style={styles.img} />
        ...
        <Text style={styles.nanas}>
          3. Discipline & Anointed (1Sam.26:1-24)
        </Text>
        <Text style={styles.publican}>
          4. S Isaac’s Wells (Genesis 26:12-32)
        </Text>
        ...
        <View style={{ gap: height * 0.02 }}>
          <View style={styles.btn}>
            <CustomButton
              ...
              onPress={() => navigation.navigate("CoreValuesTimer", { coreValueId: 23, fromScreen: 'SelfDiscipline' })}
            />
          </View>
