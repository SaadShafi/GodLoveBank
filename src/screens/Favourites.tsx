import { View, Text, StyleSheet, Image, TouchableOpacity, NativePointerEvent, FlatList } from "react-native";
        ...
        return (
            <View style={{ flex: 1 }}>
                <FlatList
                    ...
                    contentContainerStyle={{ paddingHorizontal: 10, marginTop: height * 0.015, paddingBottom: height * 0.15 }}
                />
            </View>
        )
    }
