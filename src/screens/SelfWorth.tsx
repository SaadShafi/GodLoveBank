...
const SelfWorth = () => {
  ...
  console.log('Self Worth Data:', coreValue);
...
useEffect(() => {
  ...
  return (
    <SafeAreaView style={styles.safeContainer}>
      ...
      >
        <Image source={images.selfworth} style={styles.img} />
        ...
        {/* <Text style={styles.jan}>OCTOBER</Text> */}
        <Text style={styles.jan}>{coreValue?.type}</Text>
        <Text style={styles.luke}>1. The Prodigal Son (Luke 15:11-32)</Text>
        <Text style={styles.peter}>2. Mephibosheth (2 Sam. 19:24-30)</Text>
        <Text style={styles.nanas}>3. The King’s Food (Daniel 1:1-21)</Text>
        <Text style={styles.publican}>4. The Burning Bush (Ex. 3:1-4:17)</Text>

        <View>
          <Text style={styles.today}>I am intentional and mindful about</Text>
          <Text style={styles.today}>loving and taking care of my mind </Text>
          <Text style={styles.today}>and body Today!</Text>
        </View>
        ...
        <View style={{ gap: height * 0.02 }}>
          <View style={styles.btn}>
            <CustomButton
              ...
              onPress={() => navigation.navigate("CoreValuesTimer", { coreValueId: 25, fromScreen: 'SelfWorth' })}
            />
          </View>
