  ...
  const handlecoretimer = async () => {
    ...
    try {
      ...
      if (response?.data?.data) {
        ...
        console.log("Received CoreValueId from API:", receivedCoreValueId);
        ...
        Toast.show({
         ...
         navigation.navigate("CoreValuesTimerTwo", {
            coreValueId: receivedCoreValueId,
            fromScreen: route.params?.fromScreen || 'SelfHonesty', // pass along original screen
          });
      } else {
        Toast.show({
          type: "error",
